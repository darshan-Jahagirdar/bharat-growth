...
// ── Retention / Bring-Back ROI stats ──
...
/**
 * "BharatGrowth brought back N customers worth ₹X" — current month by
 * default. Backed by get_retention_stats() (migration 041); the dashboard
 * must never hard-fail on this, so errors degrade to zeroed stats.
 */
